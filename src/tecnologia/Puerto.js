    ...
    return (
        ...
        <div className="mx-auto d-flex d-lg-none justify-content-center tablet-imagen-nave tablet-imagen-nave-sm ">
            ...
            <div className="d-flex align-items-end mt-4 overflow-hidden w-100">
                <img className="align-bottom w-100" src={"/imagenes/Bitmappuerto.png"}></img>
            </div>
        ...
        <div className="ms-lg-4 ps-lg-4 me-lg-0 pe-lg-0 pe-xl-5 me-xl-5 w-lg-50">
            ...
            <h1 className="text-light letra-bellefair fs-3 fs-sm-42 fs-lg-47 fs-xl-39 pt-1 mt-2 pb-1 text-lg-start">SPACEPORT</h1>
            <div className="container-fluid m-0 p-0">
                <div className="row m-0 p-0">
                    <div className="col-12 col-sm-2 col-lg-12"></div>
                    <div className="col-12 col-sm-8 col-lg-12 p-0">
                        <p className="text-lila fs-6 fs-lg-52 fs-xl-50 me-4  ms-4 ms-lg-0 mt-4 mt-lg-0 pb-4 lh-lg text-lg-start">A spaceport or cosmodrome is a site for launching (or receiving) spacecraft, by analogy to the seaport for ships or airport for aircraft. Based in the famous Cape Canaveral, our spaceport is ideally situated to take advantage of the Earth’s rotation for launch. </p>
                    </div>
                    <div className="col-12 col-sm-2 col-lg-12"></div>
                </div>
            </div>
        ...
        <div className="d-none d-lg-flex justify-content-end  ">
            <img className="align-bottom w-lg-100"  src={"/imagenes/Bitmappuerto_1440.png"}></img>
        </div>
    </section>
