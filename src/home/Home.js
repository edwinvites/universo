...
function setterBoton() {
    ...
    return (
        ...
        <div className="container-fluid px-4 pt-sm-5 mt-sm-5  pb-sm-5 px-lg-5 m-0  min-vh-100 h-100  w-100 ">
            <div className="row m-0 p-0  h-100 m-0 px-lg-5">
                <div className="col-12 vh-lg-50 "></div>
                            ...
                            <div className="col-12 col-lg-6 px-0 ">
                                <div className=' bg-none  w-100  d-flex flex-column justify-content-center h-100 w-100 justify-content-lg-end flex-lg-row '>
                                    <Link className="text-decoration-none   align-content-center" to={"/destinos/moon"}>
                                        <img src={logoExplorer} className="img-fluid  w-40 w-lg-100 rounded-circle shadow-explorer-hover">
