...
function Home(fondo) {
    ...
    return (
        ...
        <div className="container px-4 m-0 min-vh-100  w-100 ">
                        ...
                        <div className="row m-0 p-0 h-100">
                            ...
                            <div className="col-12 col-xl-5 px-0 h-60">
                                <div className="d-flex flex-column justify-content-between  home-padding-sm ">
                                    <p className=' mt-3 text-lila fs-1 espacio-entre-letras-punto-1 barlow-condensed text-xl-start'>SO, YOU WANT TO TRAVEL TO</p>
                                    <p className=' text-light letra-bellefair display-1 text-xl-start'>SPACE</p>
                                    <p className='text-white   fs-2 text-white-50 text-lila lh-lg text-xl-start'>Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!</p>
                                </div>
                            </div>
