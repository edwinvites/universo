                    ...
                    <div className="col-10">
                        <div className="d-flex flex-column justify-content-around h-100">
                            ...
                            <div className="m-0 ps-4 pe-0 text-start ">
                                ...
                                <p className="text-lila fs-6 me-4 ms-1 mt-4 pb-4 lh-lg">Pilot on the first operational flight of the SpaceX Crew Dragon to the International Space Station. Glover is a commander in the U.S. Navy where he pilots an F/A-18.He was a crew member of Expedition 64, and served as a station systems flight engineer. </p>
                            </div>
                            <div className="ms-2 ps-4">
                                <Circulos_cambio_d_tripulante nombre={"victor"} tamanio={1440} />
                            </div>
                        </div>
                    </div>
                    <div className="col-1"></div>
