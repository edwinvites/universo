                        ...
                        <div className="col-10">
                            ...
                            <div className="d-flex flex-column justify-content-around h-100">
                                ...
                                <div className="m-0 ps-4 pe-0 text-start ">
                                    ...
                                    <p className="text-lila fs-6 ps-1 mt-4 pb-4 lh-lg">Douglas Gerald Hurley is an
                                        American
                                        engineer, former Marine Corps pilot and former NASA astronaut. He launched into
                                        space
                                        for the third time as commander of Crew Dragon Demo-2.</p>
                                </div>
                                <div className="ms-2 ps-4">
                                    <Circulos_cambio_d_tripulante nombre={"douglas"} tamanio={1440} />
                                </div>
                        ...
                        <div className="container-fluid m-0 p-0">
                            <div className="row p-0 m-0">
                                ...
                                <div className="col-12 col-sm-10">
                                    <p className="text-lila fs-6 me-4 ms-4 mt-4 pb-4 lh-lg">Douglas Gerald Hurley is an American
                                        engineer, former Marine Corps pilot and former NASA astronaut. He launched into space
                                        for the
